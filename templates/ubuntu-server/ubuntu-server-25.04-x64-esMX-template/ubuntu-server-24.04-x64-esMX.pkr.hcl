...
variable "vm_name" {
  type    = string
  default = "ubuntu-srv-25.04-x64-esmx-template"
}
...
locals {
  template_description = "Ubutntu 25.04 Server template built ${legacy_isotime("2025-05-08 10:00:00")}, locale: es_MX username:password => localuser:password"
}
