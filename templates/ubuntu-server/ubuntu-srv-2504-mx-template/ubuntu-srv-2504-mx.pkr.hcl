variable "iso_checksum" {
  type    = string
  default = "sha256:8b44046211118639c673335a80359f4b3f0d9e52c33fe61c59072b1b61bdecc5"
}
...
variable "vm_name" {
  type    = string
  default = "ubuntu-srv-2504-mx-template"
}
...
locals {
  template_description = "Ubutntu 25.04 Server template built ${legacy_isotime("2025-05-08 10:00:00")}, 8GB RAM, 32GB LVM disk, locale: es_MX, username:password => localuser:password"
}

source "proxmox-iso" "ubuntu2504-server" {
  boot_command = [
...
build {
  sources = ["source.proxmox-iso.ubuntu2504-server"]
