...
variable "vm_name" {
  type    = string
  default = "ubuntu-srv-2404-mx-template"
}
...
locals {
  template_description = "Ubutntu 24.04 Server template built ${legacy_isotime("2025-05-08 10:00:00")}, 8GB RAM, 32GB LVM disk, locale: es_MX, username:password => localuser:password"
}
